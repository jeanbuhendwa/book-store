...
**[Book store]** is a project that uses react js and redux
...
```sh
  cd my-folder
  git clone https://github.com/jeanbuhendwa/book-store.git
```
...
If you like this project please give some stars
...
I would like to thank microverse team for providing the exercise.
